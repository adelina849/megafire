      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
		  ...
		  <ul class="sidebar-menu" data-widget="tree">
			...
			<!-- DATA DASAR APAR -->
				<li class="treeview" id="1_data_dasar">
				  <a href="#">
					<i class="fa fa-desktop"></i> <span>Data Dasar</span>
			...
			<!-- TRANSAKSI -->
				<li class="treeview" id="2_transaksi">
				  <a href="#">
					<i class="fa fa-money"></i> <span>Transaksi</span>
					<i class="fa fa-angle-left pull-right"></i>
				  </a>
				  <ul class="treeview-menu">
						<li id="41_pengaturan_Operasional_konvSatuan"><a href="<?php echo base_url();?>gl-admin-satuan-konversi"><i class="fa fa-cart-arrow-down"></i> Pembelian APAR </a></li>
				  </ul>
				</li>
			<!-- TRANSAKSI -->
			...
			<!-- LAPORAN -->
				<li class="treeview" id="3_laporan">
				  ...
				  <ul class="treeview-menu">
						<li id="41_pengaturan_Operasional_konvSatuan"><a href="<?php echo base_url();?>gl-admin-satuan-konversi"><i class="fa fa-folder-open"></i> Lap. Data APAR </a></li>
